...
export const BREEDS: Record<BreedId, BreedProfile> = {
  retriever: {
    ...
    personality: {
      ...
      prefSpeed: 'mid',
      speedTolerance: 1,
      likes: { head: 1, cheek: 1.1, ear: 0.9, chin: 1, back: 1, belly: 1.2, tail: 0.4, paw: 0.5 },
  ...
  corgi: {
    ...
    personality: {
      ...
      prefSpeed: 'fast',
      speedTolerance: 0.85,
      likes: { head: 1, cheek: 1, ear: 1.1, chin: 0.9, back: 1.1, belly: 0.8, tail: -0.9, paw: 0.2 },
  ...
  shiba: {
    ...
    personality: {
      ...
      prefSpeed: 'slow',
      speedTolerance: 0.7,
      likes: { head: 0.8, cheek: 0.7, ear: 0.5, chin: 1.1, back: 0.9, belly: -1, tail: -0.6, paw: -0.7 },
